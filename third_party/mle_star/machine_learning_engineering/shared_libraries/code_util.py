    ...
    for line in lines:
        if "Final Validation Performance" in line:
            try:
                ...
                pass
    print("[[extract_performance_from_text123123]]Extracted performance value:", performance_value)
...
def evaluate_code(
    ...
    if get_run_code_condition(
        ...
        print("[[evaluate_code123123]] Run code condition not met. Preserving existing state.")
